...
public struct TextConfiguration
{
    ...
    public FixedStack64Bytes<float> m_sizeStack;

    public FontStyles m_FontStyleInternal;
    public FontWeight m_FontWeightInternal;
    public Calli_FontStyleStack m_fontStyleStack;
    public FixedStack64Bytes<FontWeight> m_FontWeightStack;

    public HorizontalAlignmentOptions m_lineJustification;
    public FixedStack64Bytes<HorizontalAlignmentOptions> m_lineJustificationStack;

    public float m_baselineOffset;
    public FixedStack64Bytes<float> m_baselineOffsetStack;

    public Color32 m_htmlColor;
    public Color32 m_underlineColor;
    public Color32 m_strikethroughColor;

    public FixedStack64Bytes<Color32> m_colorStack;
    public FixedStack64Bytes<Color32> m_strikethroughColorStack;
    public FixedStack64Bytes<Color32> m_underlineColorStack;

    public short m_ItalicAngle;
    public FixedStack64Bytes<short> m_ItalicAngleStack;
    ...
    public FixedStack64Bytes<float> m_indentStack;
    ...
    public FixedStack64Bytes<HighlightState> m_HighlightStateStack;
    ...
    public TextConfiguration(TextBaseConfiguration textBaseConfiguration)
    {
        ...
        m_sizeStack = new FixedStack64Bytes<float>();
        ...
        m_FontWeightStack = new FixedStack64Bytes<FontWeight>();
        m_FontWeightStack.Add(m_FontWeightInternal);
        m_fontStyleStack = new Calli_FontStyleStack();

        m_lineJustification = textBaseConfiguration.lineJustification;
        m_lineJustificationStack = new FixedStack64Bytes<HorizontalAlignmentOptions>();
        m_lineJustificationStack.Add(m_lineJustification);

        m_baselineOffset = 0;
        m_baselineOffsetStack = new FixedStack64Bytes<float>();
        ...
        m_colorStack = new FixedStack64Bytes<Color32>();
        m_colorStack.Add(m_htmlColor);
        m_underlineColorStack = new FixedStack64Bytes<Color32>();
        m_underlineColorStack.Add(m_htmlColor);
        m_strikethroughColorStack = new FixedStack64Bytes<Color32>();
        m_strikethroughColorStack.Add(m_htmlColor);

        m_ItalicAngle = 0;
        m_ItalicAngleStack = new FixedStack64Bytes<short>();
        ...
        tag_Indent = 0;
        m_indentStack = new FixedStack64Bytes<float>();
        ...
        m_HighlightStateStack = new FixedStack64Bytes<HighlightState>();
