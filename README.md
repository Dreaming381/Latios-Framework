...
# Latios Framework for Unity ECS – [0.13.0-alpha.3]
...
0.13. Git hashes might not be preserved on transition to beta or official
release.**

**You are still welcome to submit bug reports and PTs for this and future
prerelease versions!**
