...
Let’s start with this 2D array with relative offset memory addresses. The bolded
...
The number of prefetchers vary by CPU but typically ranges from 2 to 16.
