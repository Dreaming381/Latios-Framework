...
namespace Latios.InternalSourceGen
{
    ...
    public static unsafe class StaticAPI
    {
        ...
        public delegate void BurstDispatchCollectionComponentDelegate(void* context, int operation);

        public static void BurstDispatchCollectionComponent<T>(void* context, int operation) where T : unmanaged, ICollectionComponentSourceGenerated, ICollectionComponent
        {
            CollectionComponentOperations.DispatchCollectionComponentOperation<T>(context, operation);
        }
        #endregion
