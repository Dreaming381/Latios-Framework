...
{
    internal static class BoxTerrain
    {
        ...
        {
            return WithinDistance(in terrain, in terrainTransform, in box, in boxTransform, 0f);
        }
        ...
        public static bool WithinDistance(in TerrainCollider terrain,
                                          ...
                                          float maxDistance)
        {
            return DistanceBetween(in terrain, in terrainTransform, in box, in boxTransform, maxDistance, out _);
        }
                                           ...
                                           out ColliderDistanceResult result)
        {
            ...
            DistanceBetweenAll(in terrain, in terrainTransform, in box, in boxTransform, maxDistance, ref processor);
            ...
            hit                      = BoxTriangle.DistanceBetween(in triangle, in terrainTransform, in box, in boxTransform, maxDistance, out result);
        ...
        {
            var aabb         = Physics.AabbFrom(box, math.mul(math.inverse(terrainTransform), boxTransform));
                                        ...
                                        out ColliderCastResult result)
        {
            ...
            var aabb                          =
                Physics.AabbFrom(boxToCast, in casterInTargetSpace, casterInTargetSpace.pos + math.rotate(targetTerrainTransformInverse, castEnd - castStart.pos));
            ...
            var triangle         = PointRayTerrain.CreateLocalTriangle(ref targetTerrain.terrainColliderBlob.Value,
                                                                       ...
                                                                       targetTerrain.scale);
            BoxTriangle.DistanceBetween(in triangle,
                                                                          ...
                                                                          in ColliderDistanceResult distanceResult)
        {
            ...
            var triangle        = PointRayTerrain.CreateLocalTriangle(ref terrain.terrainColliderBlob.Value, triangleIndices, terrain.baseHeightOffset, terrain.scale);
            return BoxTriangle.UnityContactsBetween(in triangle, in terrainTransform, in box, in boxTransform, in distanceResult);
        }
        ...
        unsafe struct DistanceBetweenAllProcessor<T> : TerrainColliderBlob.IFindTrianglesProcessor where T : unmanaged, IDistanceBetweenAllProcessor
        {
            ...
            public void Execute(ref TerrainColliderBlob blob, int3 triangleHeightIndices, int triangleIndex)
            {
                ...
                var hit                      = BoxTriangle.DistanceBetween(in triangle, in terrainTransform, in box, in boxTransform, maxDistance, out var tempResult);
        ...
        struct CastProcessor : TerrainColliderBlob.IFindTrianglesProcessor
        {
            ...
            public void Execute(ref TerrainColliderBlob blob, int3 triangleHeightIndices, int triangleIndex)
            {
                ...
                if (BoxTriangle.DistanceBetween(in triangle, in terrainTransform, in box, in castStart, 0f, out _))
                {
                    invalid = true;
                    return;
                }
                if (BoxTriangle.ColliderCast(in box, in castStart, castEnd, in triangle, in terrainTransform, out var hit))
                {
