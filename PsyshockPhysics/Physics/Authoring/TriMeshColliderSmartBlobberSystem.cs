...
namespace Latios.Psyshock.Authoring.Systems
{
    ...
    public unsafe sealed partial class TriMeshColliderSmartBlobberSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            m_query = CheckedStateRef.Fluent().With<TriMeshColliderBlobBakeData>().IncludePrefabs().IncludeDisabledEntities().Build();
        }
...
#pragma warning restore CS0618
        ...
        partial struct AddToMapJob : IJobEntity
        {
            ...
            public void Execute(in TriMeshColliderBlobBakeData data) => hashmap.TryAdd(data.mesh.GetHashCode(), new UniqueItem { bakeData = data });
        }
        ...
        struct WriteBlobsToHashmapsJob : IJob
        {
            ...
            [ReadOnly] public NativeList<TriMeshBuilder>        builders;
        ...
        partial struct AssignBlobsJob : IJobEntity
        {
            ...
            public void Execute(ref SmartBlobberResult result, in TriMeshColliderBlobBakeData data)
            {
